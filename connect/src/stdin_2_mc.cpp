...
// ------------------------------------------------------------------------------------------------------------------------------ //
//                                                                                                                                //
// Main function that reads data from stdin (std::cin) and outputs it via multicast on the given IP address and port.             //
//                                                                                                                                //
// ------------------------------------------------------------------------------------------------------------------------------ //
// ------------------------------------------------------------------------------------------------------------------------------ //
// ------------------------------------------------------------------------------------------------------------------------------ //
...
const char C_PROGRAM_NAME[] = "stdin2mc";
...
)
{
    std::cout << std::endl;
    std::cout << std::endl;
    std::cout << C_PROGRAM_NAME << " reads data from stdin and outputs them via Multicast on the given IP address and port number.";
    std::cout << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "    -p <pause>";
    std::cout << std::endl;
    std::cout << "        Wait <pause> millisconds between sending messages.";
    std::cout << std::endl;
    std::cout << "        Default: <pause> = " << C_PAUSE << ".";
    std::cout << std::endl;
...
)
{
    ...
    const char optionString[] = "bB:dDhi:l:p:P:vVXx:";
