...
class amSplitString
{
    ...
    private:
        ...
        void init( const amString &additionalSeparators = "", const amString &additionalTermnials = "" );
    ...
    public:
        ...
        amSplitString( void );
        amSplitString( const amString &, const amString &additionalSeparators = "", const amString &additionalTermnials = "" );
        ~amSplitString( void ) {};
