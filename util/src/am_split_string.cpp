...
{
    init( additionalSeparators, additionalTermnials );
    split( text );
}
...
)
{
    ...
    {
        separators = additionalSeparators;
    }

    terminals.clear();
    if ( additionalTermnials.empty() )
    {
        terminals  += '\0';
        terminals  += '\n';
        terminals  += '\r';
